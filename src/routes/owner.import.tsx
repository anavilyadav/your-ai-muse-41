          ...
          {preview.unmatched > 0 && (
            <div className="rounded-2xl bg-surface border border-border p-3.5 space-y-2">
              ...
              {[
                ...
                { key: "cardconflict" as const, label: "Naya patient lagta hai, lekin card/naam confirm nahi ho paaya", count: preview.cardNameConflict, samples: preview.cardNameConflictSamples, hint: "Do wajah ho sakti hain: (1) isi card number ki rows mein alag-alag naam hain, ya (2) isi mobile number pe ek jaisa/milta-julta naam alag-alag naye card number se mil raha hai — jaise card likhte waqt ek letter ya digit galat ban gaya ho. Safe rehne ke liye naya patient auto-create nahi kiya. Sheet mein card number check karo, sahi karke dobara upload karo." },
