...
import { BarChart3, CalendarDays, ChevronRight, IndianRupee, PhoneCall, Truck, Users, ClipboardList, Package } from "lucide-react";
  ...
  return (
    <MobileShell title="Reception Tasks" subtitle="Today" showBack>
      ...
      <div className="space-y-2">
        ...
        <ShortcutLink to="/purchase-orders" icon={Package} title="Purchase Orders" sub="Vendor se mangwana — order + saman aane pe entry" />
