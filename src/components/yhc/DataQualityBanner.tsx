...
export function DataQualityBanner({
  ...
  // Only name/card/number-confirm are self-fixable from here — shared-
  // mobile and possible-duplicate need the Owner's family-link/merge
  // tools, so those two stay informational for non-Owner staff.
  const selfFixable = flags.incompleteName || flags.partialCard || flags.unconfirmedNumber;
